...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2016 <a href="#">OJT 49 Pangkalan Balai</a>.</strong> All rights reserved.
</footer>
</div><!-- ./wrapper -->
...
<script src="<?php echo base_url('assets/AdminLTE-2.0.5/plugins/datatables/js/jquery.dataTables.min.js') ?>" type="text/javascript"></script>
<!-- SlimScroll -->
